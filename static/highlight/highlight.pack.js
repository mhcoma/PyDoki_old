...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("powershell",function(){"use strict";return function(e){
var n={$pattern:/-?[A-z\.\-]+\b/,
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}}());hljs.registerLanguage("java",function(){"use strict";function e(e){
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},c,i]}}}());hljs.registerLanguage("tcl",function(){"use strict";return function(e){return{
name:"Tcl",aliases:["tk"],
...
variants:[e.BINARY_NUMBER_MODE,e.C_NUMBER_MODE]}]}}}());hljs.registerLanguage("lisp",function(){"use strict";return function(e){
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:a}}}());hljs.registerLanguage("dos",function(){"use strict";return function(e){
...
className:"number",begin:"\\b\\d+",relevance:0},t]}}}());hljs.registerLanguage("c-like",function(){"use strict";return function(e){
...
i.name="C++",i.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],i}}());hljs.registerLanguage("julia",function(){"use strict";return function(e){
...
aliases:["jldoctest"]}]}}}());hljs.registerLanguage("vbnet",function(){"use strict";return function(e){return{
...
"meta-keyword":"if else elseif end region externalsource"}}]}}}());hljs.registerLanguage("xml",function(){"use strict";return function(e){var n={
...
begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}}());hljs.registerLanguage("dart",function(){"use strict";return function(e){
...
className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}}());hljs.registerLanguage("bash",function(){"use strict";return function(e){
...
}],illegal:/\S/}}}());hljs.registerLanguage("vim",function(){"use strict";return function(e){return{
...
className:"symbol",begin:/<[\w-]+>/}]}}}());hljs.registerLanguage("c",function(){"use strict";return function(e){
...
begin:/^\.\.\.(?=[ ]|$)/}]}]}}}());hljs.registerLanguage("fortran",function(){"use strict";return function(e){
...
end:"$"}]}}}());hljs.registerLanguage("cmake",function(){"use strict";return function(e){return{
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]}}}());hljs.registerLanguage("lua",function(){"use strict";return function(e){
...
},{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}])}}}());hljs.registerLanguage("makefile",function(){"use strict";return function(e){
...
return{name:"Plain text",aliases:["text","txt"],disableAutodetect:!0}}}());hljs.registerLanguage("delphi",function(){"use strict";return function(e){
